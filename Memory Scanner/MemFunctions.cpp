...
BOOL CMemFunctions::Initialize()
{
	...
	pNtProtectVirtualMemory = (tNtProtectVirtualMemory)MemoryGetProcAddress(m_hModNtdll, "NtProtectVirtualMemory");
	...
	pNtQueryVirtualMemory = (tNtQueryVirtualMemory)MemoryGetProcAddress(m_hModNtdll, "NtQueryVirtualMemory");
	...
	pNtReadVirtualMemory = (tNtReadVirtualMemory)MemoryGetProcAddress(m_hModNtdll, "NtReadVirtualMemory");
	...
	pNtWriteVirtualMemory = (tNtWriteVirtualMemory)MemoryGetProcAddress(m_hModNtdll, "NtWriteVirtualMemory");
